...
//					}
	...
	protected void onClick() {
        if(itemInSlot == null) {
            ...
            itemInSlot.execute( Dungeon.hero, QuickSlot.this == quickslot0 && itemInSlot.equipAction() != null ? itemInSlot.equipAction() : itemInSlot.quickAction() );
