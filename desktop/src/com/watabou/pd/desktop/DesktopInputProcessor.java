...
import com.consideredhamster.yetanotherpixeldungeon.Preferences;
import com.consideredhamster.yetanotherpixeldungeon.input.GameAction;
import com.consideredhamster.yetanotherpixeldungeon.input.PDInputProcessor;
...
public class DesktopInputProcessor extends PDInputProcessor {
	...
	static {
		...
		DEFAULTS.put( GameAction.QUICKSLOT0, new KeyPair( Input.Keys.Q ) );
		DEFAULTS.put( GameAction.QUICKSLOT1, new KeyPair( Input.Keys.NUM_1 ) );
		DEFAULTS.put( GameAction.QUICKSLOT2, new KeyPair( Input.Keys.NUM_2 ) );
		DEFAULTS.put( GameAction.QUICKSLOT3, new KeyPair( Input.Keys.NUM_3 ) );
