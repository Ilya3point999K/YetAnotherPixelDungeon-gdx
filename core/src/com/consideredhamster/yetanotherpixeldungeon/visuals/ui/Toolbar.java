...
public class Toolbar extends Component {
	...
	protected void createChildren() {
        ...
        add( btnWait = new Tool( 0, 0, 20, 24, GameAction.REST ) {
            @Override
		...
		add( btnSearch = new Tool( 20, 0, 20, 24, GameAction.SEARCH ) {
			@Override
			protected void onClick() {
        ...
        add( btnQuick0 = new QuickslotTool( 82, 0, 22, 24, GameAction.QUICKSLOT0) );
        add( btnQuick1 = new QuickslotTool( 82, 0, 22, 24, 1, GameAction.QUICKSLOT1 ) );
        add( btnQuick2 = new QuickslotTool( 82, 0, 22, 24, 2, GameAction.QUICKSLOT2 ) );
        add( btnQuick3 = new QuickslotTool( 82, 0, 22, 24, 3, GameAction.QUICKSLOT3 ) );

		add( btnInventory = new Tool( 60, 0, 22, 24, GameAction.BACKPACK ) {
...
//                }
	...
	private static class QuickslotTool extends Tool {
        ...
        public QuickslotTool( int x, int y, int width, int height, GameAction hotKey ) {
            super( x, y, width, height, hotKey );

            slot.setAsQuickSlot0();
        }

		public QuickslotTool( int x, int y, int width, int height, int index, GameAction hotKey ) {
			super( x, y, width, height, hotKey );
