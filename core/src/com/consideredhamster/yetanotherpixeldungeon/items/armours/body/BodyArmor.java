...
//        }
        ...
        if (isIdentified()) {
            info.append( "This _tier-" + tier + " " + ( !descType().equals("") ? descType() + " " : "" )  + "armor_ requires _" + itemStr + " points of strength_ to use effectively and" +
            ...
            info.append(  "Usually _tier-" + tier + " " + ( !descType().equals("") ? descType() + " " : "" )  + "armors_ require _" + itemStr + " points of strength_ to be worn effectively and" +
